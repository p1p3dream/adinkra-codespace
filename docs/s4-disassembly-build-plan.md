...
Base face: the six permutations ending in 4. True cyclic order:
`1234, 1324, 2314, 3214, 3124, 2134`. Any other order makes the drawn hexagon
self-intersect. The order currently stored in the build script
(`build_permutahedron_s4_disassembly.mjs:18`) is
`1234, 1324, 3124, 3214, 2314, 2134`, which is not cyclic.
...
3. **Fix the base hexagon cyclic order** at
   `build_permutahedron_s4_disassembly.mjs:18` to
