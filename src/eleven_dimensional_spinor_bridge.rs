...
pub fn verify() -> ElevenDimensionalSpinorBridgeReport {
    ...
    ElevenDimensionalSpinorBridgeReport {
        ...
        result:
            "the scalar factorization occupies one of twelve direct leading directions; eleven nonfactorizing directions remain, and the seven-dimensional 429 hook map space is allowed rather than an Eq. (2.7) cancellation obstruction",
        boundary:
