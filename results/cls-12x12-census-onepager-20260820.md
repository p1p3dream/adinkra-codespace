...
- Items covered: 825 of 825 (809 exact by replication, 116 direct)
...
| 12 | 44 | 84,870,432 | 68.5% |

Orbit sizes are exactly {1,4,6,12} (all divisors of 12, A4 action). The two
heaviest single items in the census (0 and 204) are both singleton orbits.
Item 52's size-12 orbit alone carries 41,255,712 matrices, 33.3% of the census.
...
- count: 3,437,976 (3rd largest; item 204 keeps the count crown at 7,430,976)
